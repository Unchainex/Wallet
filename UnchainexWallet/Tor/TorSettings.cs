...
public class TorSettings
{
	...
	/// <summary>Default port assigned to Tor SOCKS5 for the Unchainex's bundled Tor.</summary>
	public const int DefaultSocksPort = 37150;

	/// <summary>Default port assigned to Tor control for the Unchainex's bundled Tor.</summary>
		...
		bool log = true)
	{
		...
		bool defaultUnchainexTorPorts = socksPort == DefaultSocksPort && controlPort == DefaultControlPort;

		if (defaultUnchainexTorPorts)
		{
		...
		CookieAuthFilePath = defaultUnchainexTorPorts
		...
		{
			Logger.LogWarning("Unchainex is instructed to use a running Tor process. Terminate on exit was disabled.");
		}
	...
	/// <summary>Whether Tor should be terminated when Unchainex Wallet terminates.</summary>
