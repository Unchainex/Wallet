...
{
	public static T? RandomElement<T>(this IEnumerable<T> source, UnchainexRandom random)
	{
		T? current = default;
		int count = 0;
	...
	public static T? BiasedRandomElement<T>(this IEnumerable<T> source, int biasPercent, UnchainexRandom random)
	{
		foreach (T element in source)
		{
	...
	public static IList<T> Shuffle<T>(this IList<T> list, UnchainexRandom random)
	{
		int n = list.Count;
		while (n > 1)
		{
	...
	public static IList<T> ToShuffled<T>(this IEnumerable<T> list, UnchainexRandom random)
	{
