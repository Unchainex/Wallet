...
public static partial class Encode
{
	...
	public static JsonNode UnchainConfig(UnchainConfig cfg) =>
		Object([
			...
			("UW200CompatibleLoadBalancing", Bool(cfg.UW200CompatibleLoadBalancing) ),
			("UW200CompatibleLoadBalancingInputSplit", Double(cfg.UW200CompatibleLoadBalancingInputSplit) ),
...
public static partial class Decode
{
	...
	public static Decoder<UnchainConfig> UnchainConfig(string filePath) =>
		Object(get => new UnchainConfig(filePath)
		{
			...
			UW200CompatibleLoadBalancing = get.Required("UW200CompatibleLoadBalancing", Bool),
			UW200CompatibleLoadBalancingInputSplit = get.Required("UW200CompatibleLoadBalancingInputSplit", Double),
