...
public record SigningState : MultipartyTransactionState
{
	...
	public SigningState AddWitness(int index, WitScript witness)
	{
		...
		{
			throw new UnchainProtocolException(UnchainProtocolErrorCode.WitnessAlreadyProvided);
		}
		...
		{
			throw new UnchainProtocolException(UnchainProtocolErrorCode.SignatureTooLong);
		}
		...
		{
			throw new UnchainProtocolException(UnchainProtocolErrorCode.WrongCoinjoinSignature); // TODO keep script error
		}
