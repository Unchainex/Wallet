namespace UnchainexWallet.Unchain;
...
public static class ProtocolConstants
{
	...
	public const string UnchainProtocolIdentifier = "Unchain_v1.0";
	...
	public const string ProtocolViolationType = "unchain-protocol-violation";
}
