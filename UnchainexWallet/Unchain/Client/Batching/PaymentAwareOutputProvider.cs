...
using UnchainexWallet.Unchain.Client.CoinJoin.Client.Decomposer;

namespace UnchainexWallet.Unchain.Client.Batching;
...
{
	public PaymentAwareOutputProvider(IDestinationProvider destinationProvider, PaymentBatch batchedPayments, UnchainexRandom? random = null)
