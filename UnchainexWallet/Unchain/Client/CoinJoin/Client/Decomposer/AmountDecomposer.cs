...
namespace UnchainexWallet.Unchain.Client.CoinJoin.Client.Decomposer;
...
public class AmountDecomposer
{
	...
	public AmountDecomposer(FeeRate feeRate, Money minAllowedOutputAmount, Money maxAllowedOutputAmount, int availableVsize, IEnumerable<ScriptType> allowedOutputTypes, UnchainexRandom random)
	{
		FeeRate = feeRate;
	...
	private readonly UnchainexRandom _random;
