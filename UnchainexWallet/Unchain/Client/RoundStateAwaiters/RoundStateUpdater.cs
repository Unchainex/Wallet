...
{
	public RoundStateUpdater(TimeSpan requestInterval, IUnchainApiRequestHandler arenaRequestHandler) : base(requestInterval)
	{
		_arenaRequestHandler = arenaRequestHandler;
	}

	private readonly IUnchainApiRequestHandler _arenaRequestHandler;
