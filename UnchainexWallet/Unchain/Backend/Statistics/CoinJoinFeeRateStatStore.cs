...
namespace UnchainexWallet.Unchain.Backend.Statistics;

public class CoinJoinFeeRateStatStore : PeriodicRunner
{
	private readonly string _filePath;

	public CoinJoinFeeRateStatStore(string filePath, UnchainConfig config, IRPCClient rpc, IEnumerable<CoinJoinFeeRateStat> feeRateStats)
	...
	public CoinJoinFeeRateStatStore(string filePath, UnchainConfig config, IRPCClient rpc)
	...
	private readonly UnchainConfig _config;
	...
	public static CoinJoinFeeRateStatStore LoadFromFile(string filePath, UnchainConfig config, IRPCClient rpc)
	{
