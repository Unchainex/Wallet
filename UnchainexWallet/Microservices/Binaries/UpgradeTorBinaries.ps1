# Script downloads Tor Browsers, then extracts the downloaded archives and copies Tor binaries to "temp/<version>/Tor/<os-platform>" folders to be consumed by Unchainex Wallet.
...
#   Then the Tor binaries used by Unchainex Wallet are replaced with the just extracted ones.
