...
using UnchainexWallet.Coordinator.Filters;
...
namespace UnchainexWallet.Coordinator.Controllers;
...
public class UnchainController : ControllerBase, IUnchainApiRequestHandler
{
	public UnchainController(IdempotencyRequestCache idempotencyRequestCache, Arena arena, CoinJoinFeeRateStatStore coinJoinFeeRateStatStore)
	{
