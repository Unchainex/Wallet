...
using ReactiveUI;
using System.Linq;
using UnchainexWallet.Fluent.CrashReport;
using UnchainexWallet.Fluent.Helpers;
using UnchainexWallet.Logging;
using UnchainexWallet.Models;
using System.Diagnostics.CodeAnalysis;
using UnchainexWallet.Fluent.Desktop.Extensions;
using System.Net.Sockets;
using System.Collections.ObjectModel;
using UnchainexWallet.Daemon;
using LogLevel = UnchainexWallet.Logging.LogLevel;
using System.Threading;

namespace UnchainexWallet.Fluent.Desktop;
...
public class Program
{
	...
	private static AppBuilder BuildCrashReporterApp(SerializableException serializableException)
	{
		...
		return result
			...
			.With(new X11PlatformOptions { RenderingMode = new[] { X11RenderingMode.Software }, WmClass = "Unchainex Wallet Crash Report" })
...
{
	public static async Task<ExitCode> RunAsGuiAsync(this UnchainexApplication app)
	{
		return await app.RunAsync(
			afterStarting: () =>
			{
				...
				Logger.LogInfo("Unchainex GUI started.");
