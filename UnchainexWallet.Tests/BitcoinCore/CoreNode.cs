...
using UnchainexWallet.Tests.BitcoinCore.Configuration;
using UnchainexWallet.Tests.BitcoinCore.Configuration.Whitening;
using UnchainexWallet.Tests.BitcoinCore.Processes;
using UnchainexWallet.Userfacing;

namespace UnchainexWallet.Tests.BitcoinCore;
...
public class CoreNode
{
	...
	public static async Task<CoreNode> CreateAsync(CoreNodeParams coreNodeParams, CancellationToken cancel)
	{
		...
		var sectionComment = $"# The following configuration options were added or modified by Unchainex Wallet.";
