...
public class NBitcoinTests
{
	...
	{
		Assert.Equal(UnchainexWallet.Helpers.Constants.DefaultMainNetBitcoinCoreRpcPort, Network.Main.RPCPort);
		Assert.Equal(UnchainexWallet.Helpers.Constants.DefaultTestNetBitcoinCoreRpcPort, Network.TestNet.RPCPort);
		Assert.Equal(UnchainexWallet.Helpers.Constants.DefaultRegTestBitcoinCoreRpcPort, Network.RegTest.RPCPort);
	}
