...
public class GetInfoCircuitStatusReplyTests
{
	...
	public async Task ParseReplyAsync()
	{
		...
		// Circuit #5.
		{
			...
			Assert.Equal("unchainexukrxmkdgve5kynjztuovbg43uxcbcxn6y2okcrsg7gb6jdmbad", circuitInfo.RendQuery);
