...
namespace UnchainexWallet.Tests.UnitTests.Tor.Control.Messages;
...
public class ProtocolInfoReplyTests
{
	...
	{
		// Yes, Tor really returns: "C:\\Users\\Unchainex\\AppData\\Roaming\\UnchainexWallet\\Client\\control_auth_cookie" path on Windows.
		string data = "250-PROTOCOLINFO 1\r\n250-AUTH METHODS=COOKIE,SAFECOOKIE COOKIEFILE=\"C:\\\\Users\\\\Unchainex\\\\AppData\\\\Roaming\\\\UnchainexWallet\\\\Client\\\\control_auth_cookie\"\r\n250-VERSION Tor=\"0.4.5.7\"\r\n250 OK\r\n";
		...
		Assert.Equal(@"C:\Users\Unchainex\AppData\Roaming\UnchainexWallet\Client\control_auth_cookie", reply.CookieFilePath);
	}
}
