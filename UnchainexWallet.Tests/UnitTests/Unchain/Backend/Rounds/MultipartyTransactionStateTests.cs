...
namespace UnchainexWallet.Tests.UnitTests.Unchain.Backend.Rounds;
...
public class MultipartyTransactionStateTests
{
	...
	public void CanGetDifferentialStateTest()
	{
		...
		(var coin1, var ownershipProof1) = UnchainFactory.CreateCoinWithOwnershipProof(roundId: round.Id);
		(var coin2, var ownershipProof2) = UnchainFactory.CreateCoinWithOwnershipProof(roundId: round.Id);
		(var coin3, var ownershipProof3) = UnchainFactory.CreateCoinWithOwnershipProof(roundId: round.Id);
