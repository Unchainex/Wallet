...
public class SerializationTests
{
	...
	{
		var round = UnchainFactory.CreateRound(new UnchainexWallet.Unchain.Backend.UnchainConfig());
		...
		(var coin, var ownershipProof) = UnchainFactory.CreateCoinWithOwnershipProof(roundId: round.Id);
