...
public static class Common
{
	...
	/// <remarks>Tor is instructed to terminate on exit because this Tor instance would prevent running your Unchainex Wallet where Tor is started with data in a different folder.</remarks>
	public static TorSettings TorSettings => new(DataDir, TorDistributionFolder, terminateOnExit: true);

	public static string DataDir => EnvironmentHelpers.GetDataDir(Path.Combine("UnchainexWallet", "Tests"));
