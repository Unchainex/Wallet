...
public class WalletTests : IClassFixture<RegTestFixture>
{
	...
	public async Task WalletTestsAsync()
	{
		...
		// 2. Create unchainex synchronizer service.
		...
		WalletFactory walletFactory = new(workDir, network, bitcoinStore, setup.ServiceConfiguration, feeProvider, blockDownloadService);
