...
public static class MacOsStartupHelper
{
	...
	private static readonly string PlistContent =
		...
		<dict>
		    <key>Label</key>
		    <string>com.unchainexwallet.startup</string>
	...
	{
		// From 2.0.6, we use LaunchAgents instead of Login Items to run Unchainex hidden during startup. We need to delete older existing Login Items.
