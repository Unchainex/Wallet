...
namespace UnchainexWallet.Fluent.ViewModels.Wallets.Home.History.Features;
...
public partial class CancelTransactionDialogViewModel : RoutableViewModel
{
	...
	private async Task OnCancelTransactionAsync(CancellingTransaction cancellingTransaction)
	{
		...
		catch (Exception ex)
		{
			...
			UiContext.Navigate().To().ShowErrorDialog(msg, "Cancellation Failed", "Unchainex was unable to cancel your transaction.", NavigationTarget.CompactDialogScreen);
		}
