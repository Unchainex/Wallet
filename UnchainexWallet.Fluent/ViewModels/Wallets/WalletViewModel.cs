...
using UnchainexWallet.Fluent.ViewModels.Wallets.Home.History;
using UnchainexWallet.Fluent.ViewModels.Wallets.Home.Tiles;
using UnchainexWallet.Fluent.ViewModels.Wallets.Settings;
...
{
	public static string FindCoordinatorLink { get; } = "https://docs.unchainex.org/FAQ/FAQ-UseUnchainex.html#how-do-i-find-a-coordinator";
	...
	public WalletViewModel(UiContext uiContext, IWalletModel walletModel, Wallet wallet)
	{
		...
		CoordinatorHelpCommand = ReactiveCommand.CreateFromTask(() => UiContext.FileSystem.OpenBrowserAsync("https://docs.unchainex.org/FAQ/FAQ-UseUnchainex.html#how-do-i-find-a-coordinator"));
	...
	{
		return new ActionableItem("Donate", "Donate to The Unchainex Wallet Developers", () => { DonateCommand.ExecuteIfCan(); return Task.CompletedTask; }, "Wallet", new[] { "Wallet", "Send", "Action", "Donate" }) { Icon = "gift", IsDefault = true, Priority = 4 };
	}
