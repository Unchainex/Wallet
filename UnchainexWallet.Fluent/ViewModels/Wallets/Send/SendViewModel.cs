...
using UnchainexWallet.WebClients.PayJoin;
...
using Address = UnchainexWallet.Userfacing.Address;
...
public partial class SendViewModel : RoutableViewModel
{
	...
	public SendViewModel(UiContext uiContext, IWalletModel walletModel, SendFlowModel parameters)
	{
		...
		_defaultLabel = _parameters.Donate ? "Unchainex team" : "";
	...
	protected override void OnNavigatedTo(bool inHistory, CompositeDisposable disposables)
	{
		...
		if (_parameters.Donate)
		{
			...
			Caption = "Donate to The Unchainex Wallet Developers to continue maintaining the software";
			IsFixedAddress = true;
			TryParseUrl(_to);
		}
	}
