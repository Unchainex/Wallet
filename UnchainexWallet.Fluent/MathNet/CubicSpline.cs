// Copyright (c) 2009-2014 Math.NET Taken from http://github.com/mathnet/mathnet-numerics and modified for Unchainex Wallet

namespace UnchainexWallet.Fluent.MathNet;
