...
{ fetchNuGet }: [
  (fetchNuGet { pname = "Avalonia"; version = "11.2.5"; hash = "sha256-DGTMzInnfvJUJWu2SXiRBercxxe1/paQkSlBHMahp4g="; })
  ...
  (fetchNuGet { pname = "Avalonia.Controls.ColorPicker"; version = "11.2.5"; hash = "sha256-gWGIqXrac0fOnmGbovcFWv5Uj14hOyC+n0l45N7owMg="; })
  (fetchNuGet { pname = "Avalonia.Controls.DataGrid"; version = "11.2.5"; hash = "sha256-eGKc+UnsO5nNiUd7+n3CQW6vIWq2qpazYvYXrVTQY7s="; })
  (fetchNuGet { pname = "Avalonia.Controls.TreeDataGrid"; version = "11.1.1"; hash = "sha256-pEh7qGLhkirOW81xqy8iRMmFpOgdyTFpWpUHrkHgmcM="; })
  (fetchNuGet { pname = "Avalonia.Desktop"; version = "11.2.5"; hash = "sha256-rDJ1NJM3tEqB7sRszj0AfplwkkvtE3Hvn7acrIsq+yw="; })
  (fetchNuGet { pname = "Avalonia.Diagnostics"; version = "11.2.5"; hash = "sha256-WsAMBmNfUKMB2II3AfM8A0klfJR/vgEtRUTGpgC6F3A="; })
  (fetchNuGet { pname = "Avalonia.Fonts.Inter"; version = "11.2.5"; hash = "sha256-cPdNS/VWH6yZ/9Ea+U5UBx6RgC0SpkhKonBxZ6InLLU="; })
  (fetchNuGet { pname = "Avalonia.FreeDesktop"; version = "11.2.5"; hash = "sha256-rLzsxUQS1LLLcLWkDR8SLLwLY53vUMqgiKoDWM6PjtM="; })
  (fetchNuGet { pname = "Avalonia.Headless"; version = "11.2.5"; hash = "sha256-vly40k9GMe1Y8m5TlFx0uq0HPEfBjqlxcpj9vCHI59Q="; })
  (fetchNuGet { pname = "Avalonia.Headless.XUnit"; version = "11.2.5"; hash = "sha256-cvgluwxmaQGVUxX8k43pGq8zM2v2ToDCJcmjECsXQMU="; })
  (fetchNuGet { pname = "Avalonia.Native"; version = "11.2.5"; hash = "sha256-XQQgcfbRRHPzH432M1KzkSEtLQof40yCt+KIrQREBY0="; })
  (fetchNuGet { pname = "Avalonia.ReactiveUI"; version = "11.2.5"; hash = "sha256-p3ELTiH4kYdcrUF87zZzRMsOU41Q3XBCBKRmQYWdLBs="; })
  (fetchNuGet { pname = "Avalonia.Remote.Protocol"; version = "11.2.5"; hash = "sha256-Mpml6U6Fl8FUvENGQxpxuw0+pOPvoWbZXV4V1bLUS9w="; })
  (fetchNuGet { pname = "Avalonia.Skia"; version = "11.2.5"; hash = "sha256-su1K1RmQ+syE6ufjrzpQR1yiUa6GEtY5QPlW0GOVKnU="; })
  (fetchNuGet { pname = "Avalonia.Svg"; version = "11.0.0"; hash = "sha256-edKxg+OsZ2EkWvSDpGxRTLmEx3U1G0+6CbRJy4VUr/Y="; })
  (fetchNuGet { pname = "Avalonia.Themes.Fluent"; version = "11.2.5"; hash = "sha256-Wb6H3Vb5gsL8bKzmaJgFZBEsu3MI0CCdlXfO5SLisdo="; })
  (fetchNuGet { pname = "Avalonia.Themes.Simple"; version = "11.2.5"; hash = "sha256-EjQ2XA81SS91h8oGUwVxLYewm3Lp5Sa2Lmbj0c8y8BU="; })
  (fetchNuGet { pname = "Avalonia.Win32"; version = "11.2.5"; hash = "sha256-ljgJgXDxmHOUQ+p8z62mtaK4FTmYAI+c+6gL2lczD/8="; })
  (fetchNuGet { pname = "Avalonia.X11"; version = "11.2.5"; hash = "sha256-wHEHcEvOUyIBgBtQZOIs330KajSv8DSEsJP7w4M9i4E="; })
  (fetchNuGet { pname = "Avalonia.Xaml.Behaviors"; version = "11.2.0.14"; hash = "sha256-Ep/IOiZyLDoIKrymqXtFPw2hrXQBpu8Dn+4YZ3/3Z4I="; })
  (fetchNuGet { pname = "Avalonia.Xaml.Interactions"; version = "11.2.0.14"; hash = "sha256-7bk1zc2hZdTg+Y7LaDSb1CmL6yv0GeZAWKh3gf9bVm8="; })
  (fetchNuGet { pname = "Avalonia.Xaml.Interactions.Custom"; version = "11.2.0.14"; hash = "sha256-RSIczkm9V/fKoOavXJQd931b9r/GBvuz0hR4HD6Wgd4="; })
  (fetchNuGet { pname = "Avalonia.Xaml.Interactions.DragAndDrop"; version = "11.2.0.14"; hash = "sha256-kRx4GMzoHZULJoUUptt9Xa7+UFYoiirI+wE6JuBBklc="; })
  (fetchNuGet { pname = "Avalonia.Xaml.Interactions.Draggable"; version = "11.2.0.14"; hash = "sha256-ywaaUhDqj+yHJjnRPCu3HXYr/sSPrrlwiqN30vYqRLk="; })
  (fetchNuGet { pname = "Avalonia.Xaml.Interactions.Events"; version = "11.2.0.14"; hash = "sha256-CE7nh1ld747CGoPYiu4KlQxwP9yiG9/OMHwq8GpL0so="; })
  (fetchNuGet { pname = "Avalonia.Xaml.Interactions.Responsive"; version = "11.2.0.14"; hash = "sha256-vyc/HXfDAEi1AbAwkphrlVpckrM5ykptXYp/l5ul8VQ="; })
  (fetchNuGet { pname = "Avalonia.Xaml.Interactivity"; version = "11.2.0.14"; hash = "sha256-SZIVuXdT1PN3zBCpVv3F6Y5vaOp8CTsq0/HVHXrbc6Y="; })
  ...
  (fetchNuGet { pname = "Unchain"; version = "1.0.1.1"; hash = "sha256-6hnJ1OsOPVw8OSMd4CBltZJMu+yQvOicUdPLg/4RLbQ="; })
