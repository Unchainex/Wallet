{
  description = "Unchainex Wallet flake";
  ...
  outputs = { self, nixpkgs }:
    let
        ...
        buildUnchainexModule = pkgs.buildDotnetModule {
          pname = "unchainex";
        ...
        # Build Unchainex Backend
        buildBackend = buildUnchainexModule.overrideAttrs (oldAttrs: rec {
          pname = "UnchainexWallet.Backend";
          projectFile = "UnchainexWallet.Backend/UnchainexWallet.Backend.csproj";
          executables = [ "UnchainexWallet.Backend" ];
        ...
        buildEverything = buildUnchainexModule.overrideAttrs (oldAttrs: rec {
          pname = "UnchainexWallet";
          projectFile = [
             "UnchainexWallet.Backend/UnchainexWallet.Backend.csproj"
             "UnchainexWallet.Backend/UnchainexWallet.Coordinator.csproj"
             "UnchainexWallet.Fluent.Desktop/UnchainexWallet.Fluent.Desktop.csproj"];
          executables = [
            "UnchainexWallet.Backend"
            "UnchainexWallet.Coordinator"
          ...
          # Testing
          doCheck = true;
          testProjectFile = "UnchainexWallet.Tests/UnchainexWallet.Tests.csproj";
          ...
          preFixup = ''
            wrapDotnetProgram $out/lib/${pname}/UnchainexWallet.Fluent.Desktop $out/bin/unchainex
            wrapDotnetProgram $out/lib/${pname}/UnchainexWallet.Backend $out/bin/wbend
          '';

          microservices = "./UnchainexWallet/Microservices/Binaries/lin64/";
          preBuild = ''
        ...
        unchainex-shell = pkgs.mkShell {
           name = "unchainex-shell";
           packages = [
    ...
    in
    {
      ...
      devShells.x86_64-linux.default = unchainex-shell;
