...
using System.Linq;
using UnchainexWallet.Fluent.Generators.Analyzers;

namespace UnchainexWallet.Fluent.Generators;
...
public static class AnalyzerExtensions
{
	...
	{
		return node.IsSubTypeOf(model, "UnchainexWallet.Fluent.ViewModels.Navigation.RoutableViewModel");
	}
