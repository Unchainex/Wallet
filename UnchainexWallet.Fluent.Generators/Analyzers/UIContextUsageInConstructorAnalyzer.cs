...
namespace UnchainexWallet.Fluent.Generators.Analyzers;
...
{
	public const string UiContextType = "UnchainexWallet.Fluent.Models.UI.UiContext";
	public const string UiContextFileSuffix = "_UiContext.cs";
	public const string DialogViewModelBaseType = "UnchainexWallet.Fluent.ViewModels.Dialogs.Base.DialogViewModelBase<TResult>";
	...
	internal static readonly DiagnosticDescriptor Rule1 =
		new("WW001",
			...
			"UiContext cannot be referenced in a ViewModel's constructor because it hasn't been initialized yet when constructor runs. Use OnNavigatedTo() or OnActivated() instead. Alternatively, make the constructor public and explicitly initialize UiContext. See https://github.com/Unchainex/Wallet/blob/master/CONTRIBUTING.md#source-generated-viewmodel-constructors for details.",
			"Unchainex Wallet",
