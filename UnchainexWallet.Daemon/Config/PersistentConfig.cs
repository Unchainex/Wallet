...
public record PersistentConfig
{
	...
	{
		if (MainNetBackendUri == "https://unchainex.org/" || TestNetBackendUri == "https://unchainex.ru/")
		{
			return this with
			{
				MainNetBackendUri = "https://api.unchainex.org/",
				TestNetBackendUri = "https://api.unchainex.ru/",
			};
		}
